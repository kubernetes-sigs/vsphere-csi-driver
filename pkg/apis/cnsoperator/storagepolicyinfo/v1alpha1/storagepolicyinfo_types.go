...
type StoragePolicyInfoStatus struct {
	// StorgePolicyDeleted indicates whether the underlying storagepolicy is deleted or not on the VC.
	// +optional
	StorgePolicyDeleted bool `json:"storagePolicyDeleted,omitempty"`
