...
// Topology describes topology accessibility for the storage policy within the namespace.
...
type StoragePolicyInfoStatus struct {
	// Topology contains observed topology for this storage policy in the namespace.
	// +optional
...
// +kubebuilder:resource:scope=Namespaced,shortName=spi,path=storagepolicyinfoes
