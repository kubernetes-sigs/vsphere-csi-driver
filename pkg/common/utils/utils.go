...
func GetVirtualMachineAllApiVersions(ctx context.Context, vmKey types.NamespacedName,
	...
	log := logger.GetLogger(ctx)
	vmV1alpha5 := &vmoperatorv1alpha5.VirtualMachine{}
	apiVersion := vmOperatorApiVersionPrefix + "/v1alpha5"
	log.Info("GetVirtualMachineAllApiVersions: get virtualmachine crd version")
	version, err := GetLatestCRDVersion(ctx, VirtualMachineCRDName)
	if err != nil {
		log.Errorf("failed to get latest CRD version for %s: %s", VirtualMachineCRDName, err)
	...
	case "v1alpha1":
		...
		if err != nil {
			log.Errorf("GetVirtualMachineAllApiVersions: failed to get VirtualMachine "+
				"%s/%s with version v1alpha1, error %v", vmKey.Name, vmKey.Namespace, err)
			return nil, apiVersion, err
		}
		...
		err = vmoperatorv1alpha1.Convert_v1alpha1_VirtualMachine_To_v1alpha5_VirtualMachine(
			vmV1alpha1, vmV1alpha5, nil)
		if err != nil {
			log.Errorf("failed to convert VirtualMachines v1alpha1 to v1alpha5. %s", err.Error())
			return nil, apiVersion, err
		}
	case "v1alpha2":
		...
		if err != nil {
			log.Errorf("GetVirtualMachineAllApiVersions: failed to get VirtualMachine "+
				"%s/%s with version v1alpha2, error %v", vmKey.Name, vmKey.Namespace, err)
			return nil, apiVersion, err
		}
		...
		err = vmoperatorv1alpha2.Convert_v1alpha2_VirtualMachine_To_v1alpha5_VirtualMachine(
			vmV1alpha2, vmV1alpha5, nil)
		if err != nil {
			log.Errorf("failed to convert VirtualMachines v1alpha2 to v1alpha5. %s", err.Error())
			return nil, apiVersion, err
		}
	case "v1alpha3":
		...
		if err != nil {
			log.Errorf("GetVirtualMachineAllApiVersions: failed to get VirtualMachine "+
				"%s/%s with version v1alpha3, error %v", vmKey.Name, vmKey.Namespace, err)
			return nil, apiVersion, err
		}
		...
		err = vmoperatorv1alpha3.Convert_v1alpha3_VirtualMachine_To_v1alpha5_VirtualMachine(
			vmV1alpha3, vmV1alpha5, nil)
		if err != nil {
			log.Errorf("failed to convert VirtualMachines v1alpha3 to v1alpha5. %s", err.Error())
			return nil, apiVersion, err
		}
	case "v1alpha4":
		...
		if err != nil {
			log.Errorf("GetVirtualMachineAllApiVersions: failed to get VirtualMachine "+
				"%s/%s with version v1alpha4, error %v", vmKey.Name, vmKey.Namespace, err)
			return nil, apiVersion, err
		}
		log.Debugf("GetVirtualMachineAllApiVersions: converting v1alpha3 VirtualMachine "+
			"to v1alpha4 VirtualMachine, name %s", vmV1alpha4.Name)
		...
		err = vmoperatorv1alpha4.Convert_v1alpha4_VirtualMachine_To_v1alpha5_VirtualMachine(
			vmV1alpha4, vmV1alpha5, nil)
		if err != nil {
			log.Errorf("failed to convert VirtualMachines v1alpha4 to v1alpha5. %s", err.Error())
			return nil, apiVersion, err
		}
	default:
		err = vmOperatorClient.Get(ctx, vmKey, vmV1alpha5)
		if err != nil {
			log.Errorf("GetVirtualMachineAllApiVersions: failed to get VirtualMachine "+
				"%s/%s with version %s, error %v", vmKey.Name, vmKey.Namespace, version, err)
			return nil, apiVersion, err
		}
	}
	log.Infof("successfully fetched the virtual machines with name %s and namespace %s",
		vmKey.Name, vmKey.Namespace)
	return vmV1alpha5, apiVersion, nil
}
...
func PatchVirtualMachine(ctx context.Context, vmOperatorClient client.Client,
	vm, oldvm *vmoperatorv1alpha5.VirtualMachine) error {
	log := logger.GetLogger(ctx)
	log.Info("PatchVirtualMachine: get virtualmachine crd version")
	version, err := GetLatestCRDVersion(ctx, VirtualMachineCRDName)
	if err != nil {
		log.Errorf("failed to get latest CRD version for %s: %s", VirtualMachineCRDName, err)
		return err
	...
	switch version {
	case "v1alpha1":
		vmV1alpha1, old_vmV1alpha1 := &vmoperatorv1alpha1.VirtualMachine{},
		...
		err = vmoperatorv1alpha1.Convert_v1alpha5_VirtualMachine_To_v1alpha1_VirtualMachine(
			oldvm, old_vmV1alpha1, nil)
		if err != nil {
			return err
		}
		vmPatch1 := client.MergeFromWithOptions(
			old_vmV1alpha1.DeepCopy(), client.MergeFromWithOptimisticLock{})
		err := vmOperatorClient.Patch(ctx, vmV1alpha1, vmPatch1)
		if err != nil {
			log.Errorf("PatchVirtualMachine: error while patching virtualmachine name: %s with "+
				" version %s, err %v", vm.Name, version, err)
			return err
		}
	case "v1alpha2":
		vmV1alpha2, old_vmV1alpha2 := &vmoperatorv1alpha2.VirtualMachine{},
			&vmoperatorv1alpha2.VirtualMachine{}
		log.Infof("PatchVirtualMachine: converting virtualMachine to "+
		...
		err = vmoperatorv1alpha2.Convert_v1alpha5_VirtualMachine_To_v1alpha2_VirtualMachine(
			oldvm, old_vmV1alpha2, nil)
		if err != nil {
			return err
		}
		vmPatch2 := client.MergeFromWithOptions(
			old_vmV1alpha2.DeepCopy(), client.MergeFromWithOptimisticLock{})
	...
	case "v1alpha3":
		vmV1alpha3, old_vmV1alpha3 := &vmoperatorv1alpha3.VirtualMachine{},
			&vmoperatorv1alpha3.VirtualMachine{}
		log.Infof("PatchVirtualMachine: converting virtualMachine to "+
		...
		err = vmoperatorv1alpha3.Convert_v1alpha5_VirtualMachine_To_v1alpha3_VirtualMachine(
			oldvm, old_vmV1alpha3, nil)
		if err != nil {
			return err
		}
		vmPatch3 := client.MergeFromWithOptions(
			old_vmV1alpha3.DeepCopy(), client.MergeFromWithOptimisticLock{})
	...
	case "v1alpha4":
		vmV1alpha4, old_vmV1alpha4 := &vmoperatorv1alpha4.VirtualMachine{},
			&vmoperatorv1alpha4.VirtualMachine{}
		log.Infof("PatchVirtualMachine: converting virtualMachine to "+
	...
	default:
		vmPatch := client.MergeFromWithOptions(
			oldvm.DeepCopy(), client.MergeFromWithOptimisticLock{})
...
func UpdateVirtualMachine(ctx context.Context, vmOperatorClient client.Client,
	...
	log := logger.GetLogger(ctx)
	log.Info("UpdateVirtualMachine: get virtualmachine crd version")
	version, err := GetLatestCRDVersion(ctx, VirtualMachineCRDName)
	if err != nil {
		log.Errorf("failed to get latest CRD version for %s: %s", VirtualMachineCRDName, err)
		return err
	...
	case "v1alpha1":
		...
		if err != nil {
			log.Errorf("UpdateVirtualMachine: error while update virtualmachine name: %s with "+
				" version %s, err %v", vm.Name, version, err)
			return err
		}
	case "v1alpha2":
