...
func TestListVirtualMachines(t *testing.T) {
	...
	t.Run("WhenLatestCRDVersionIsV1Alpha1", func(tt *testing.T) {
		...
		tt.Run("WhenListFails", func(ttt *testing.T) {
			...
			clientBuilder.WithInterceptorFuncs(interceptor.Funcs{List: func(ctx context.Context, client client.WithWatch, list client.ObjectList, opts ...client.ListOption) error {
