...
func TestListVirtualMachines(t *testing.T) {
	...
	t.Run("WhenLatestCRDVersionIsV1Alpha1", func(tt *testing.T) {
		...
		tt.Run("WhenListSucceeds", func(ttt *testing.T) {
			...
			v1Alpha4VM1 := vmoperatorv1alpha2.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: namespace.Name,
				},
			}
			v1Alpha4VM2 := vmoperatorv1alpha2.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm2",
					Namespace: namespace.Name,
				},
			}
			exp := vmoperatorv1alpha2.VirtualMachineList{
				TypeMeta: metav1.TypeMeta{},
				ListMeta: metav1.ListMeta{},
				Items: []vmoperatorv1alpha2.VirtualMachine{
					v1Alpha4VM1,
					v1Alpha4VM2,
				},
			}
...
func compareVirtualMachineLists(exp, actual vmoperatorv1alpha2.VirtualMachineList) bool {
