...
// GetListOfAttachedVolumes returns list of FCDs (present in the K8s cluster)
// which are attached to given VM on vCenter.
func GetListOfAttachedVolumesForVM(ctx context.Context, volumeIdToPvc map[string]string,
