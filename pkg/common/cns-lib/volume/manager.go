...
func (m *defaultManager) createSnapshotWithImprovedIdempotency(ctx context.Context, volumeID string, snapshotName string) (*CnsSnapshotInfo, error) {
	return nil, nil
}

// The snapshotName parameter denotes the snapshot description required by CNS CreateSnapshot API. This parameter is expected
// to be filled with the CSI CreateSnapshotRequest Name, which is generated by the CSI snapshotter sidecar.
func (m *defaultManager) CreateSnapshot(ctx context.Context, volumeID string, snapshotName string) (*CnsSnapshotInfo, error) {
