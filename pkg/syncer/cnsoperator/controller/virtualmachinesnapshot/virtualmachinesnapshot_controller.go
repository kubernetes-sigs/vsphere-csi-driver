...
func Add(mgr manager.Manager, clusterFlavor cnstypes.CnsClusterFlavor,
	...
	vmOperatorClient, err := k8s.NewClientForGroup(ctx, restClientConfig, vmoperatorv1alpha5.GroupName)
	if err != nil {
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(source.Kind(mgr.GetCache(),
		&vmoperatorv1alpha5.VirtualMachineSnapshot{},
		&handler.TypedEnqueueRequestForObject[*vmoperatorv1alpha5.VirtualMachineSnapshot]{}))
	if err != nil {
...
func (r *ReconcileVirtualMachineSnapshot) Reconcile(ctx context.Context,
	...
	vmSnapshot := &vmoperatorv1alpha5.VirtualMachineSnapshot{}
...
func (r *ReconcileVirtualMachineSnapshot) reconcileNormal(ctx context.Context, log *zap.SugaredLogger,
	vmsnapshot *vmoperatorv1alpha5.VirtualMachineSnapshot) error {
...
func recordEvent(ctx context.Context, r *ReconcileVirtualMachineSnapshot,
	instance *vmoperatorv1alpha5.VirtualMachineSnapshot, eventtype string, msg string) {
...
func (r *ReconcileVirtualMachineSnapshot) syncVolumesAndUpdateCNSVolumeInfo(ctx context.Context,
	log *zap.SugaredLogger, vm *vmoperatorv1alpha5.VirtualMachine) error {
	var err error
