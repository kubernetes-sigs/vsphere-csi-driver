...
const (
	...
	// snapshotMetadataServiceAPIGroup owns the SnapshotMetadataService CR being exported.
	snapshotMetadataServiceAPIGroup = "cbt.storage.k8s.io"
...
func exportReaderClusterRole() *rbacv1.ClusterRole {
	return &rbacv1.ClusterRole{
		...
		Rules: []rbacv1.PolicyRule{
			{
				APIGroups: []string{snapshotMetadataServiceAPIGroup},
		...
		Object: map[string]interface{}{
			...
			"spec": map[string]interface{}{
				"source": map[string]interface{}{
					"apiGroup": snapshotMetadataServiceAPIGroup,
