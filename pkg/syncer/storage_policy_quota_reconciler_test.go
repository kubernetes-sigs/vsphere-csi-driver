...
//
// This also covers the startup path: the SPQ informer fires AddFunc for every
// existing object during its initial LIST, so addStoragePolicyQuota is called
// for pre-existing SPQs before WaitForCacheSync returns.
