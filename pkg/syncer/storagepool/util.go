...
func RetryOnError(task func() error, baseDuration, maxBackoffDuration time.Duration, multiplier float64, retries int) {
	...
	_, _ = ExponentialBackoff(taskFunc, baseDuration, maxBackoffDuration, multiplier, retries)
}
