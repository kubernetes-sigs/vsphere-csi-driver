...
var (
	...
	// The following variables hold feature states for authorisation check.
	filterSuspendedDatastores, isTopologyAwareFileVolumeEnabled, isCSITransactionSupportEnabled bool
