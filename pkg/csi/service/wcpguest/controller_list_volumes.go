...
var listVolumesListTimeout = 30 * time.Second
...
// A Block VolumeMode always wins regardless of access mode, since raw block volumes can be
// provisioned with RWX/ROX access too.
