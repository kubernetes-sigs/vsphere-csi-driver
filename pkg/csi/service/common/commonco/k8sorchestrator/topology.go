...
func (volTopology *nodeVolumeTopology) GetNodeTopologyLabels(ctx context.Context, info *commoncotypes.NodeInfo) (
...
func (volTopology *controllerVolumeTopology) getSharedDatastoresInTopology(ctx context.Context, topologyArr []*csi.Topology) (
	[]*cnsvsphere.DatastoreInfo, map[string][]map[string]string, error) {
	log := logger.GetLogger(ctx)
