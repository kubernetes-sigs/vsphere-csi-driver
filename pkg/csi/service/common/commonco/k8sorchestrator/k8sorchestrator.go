...
// getPrintableCapabilitiesMap converts Capabilities sync map to regular map and returns it
func getPrintableCapabilitiesMap(m *sync.Map) map[string]bool {
...
func (c *K8sOrchestrator) HandleLateEnablementOfCapability(ctx context.Context,
	...
	for range ticker.C {
		...
		printableMap := getPrintableCapabilitiesMap(WcpCapabilitiesMap)
		log.Debugf("WCP cluster capabilities map - %+v", printableMap)
