...
var _ = ginkgo.Describe("Volume Expansion Test", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-supervisor-serialized] [csi-guest] [csi-block-vanilla-parallelized] "+
	...
	ginkgo.It("[csi-block-vanilla] [csi-guest] [csi-supervisor-parallelized]  [csi-block-vanilla-parallelized] "+
		"Verify offline volume expansion shrinking volume not allowed", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-guest] [csi-supervisor-serialized] [csi-block-vanilla-parallelized] "+
	...
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor-serialized]  [csi-block-vanilla-parallelized] "+
	...
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor-parallelized] [csi-guest] [csi-block-vanilla-parallelized] "+
	...
	*/
	...
	ginkgo.It("[csi-block-vanilla] [csi-supervisor-serialized] [csi-guest] [csi-block-vanilla-serialized] "+
	...
	*/
	ginkgo.It("[csi-supervisor-serialized] Offline and Online volume resize on statically created volume", func() {
		var err error
		var fsSize int64
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	*/
	ginkgo.It("[csi-supervisor-serialized] Verify offline and online volume expansion when"+
		" there is no quota available", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	/*
		...
		11. Make sure file system has increased
	*/
	ginkgo.It("[csi-supervisor-serialized] Verify Offline volume expansion when SPS-Service is down ", func() {
	...
	*/
	...
	ginkgo.It("[csi-supervisor-serialized] Verify Offline volume expansion when VSAN-health is down", func() {
	...
	*/
	ginkgo.It("[csi-supervisor-parallelized] [csi-block-vanilla] [csi-guest] [csi-block-vanilla-parallelized] "+
	...
	*/
	...
	/*
		...
		10.Make sure file system has increased
	*/
	ginkgo.It("[csi-supervisor-serialized] Verify online volume expansion when CSI Pod is down", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
		var vmUUID string
	...
	*/
	...
	ginkgo.It("[csi-supervisor-serialized] Verify Offline volume expansion when CSI Pod is down", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
		var vmUUID string
	...
	*/
	ginkgo.It("[csi-supervisor-serialized] Verify offline volume expansion when PVC is deleted", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
