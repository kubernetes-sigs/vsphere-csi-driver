...
var _ = ginkgo.Describe("Volume Expansion Test", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-guest] [csi-block-vanilla-parallelized] Verify volume expansion with no filesystem before expansion", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-guest]  [csi-block-vanilla-parallelized] Verify volume expansion with initial filesystem before expansion", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-guest]  [csi-block-vanilla-parallelized] Verify volume expansion not allowed", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-guest] [csi-supervisor]  [csi-block-vanilla-parallelized] Verify volume shrinking not allowed", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-block-vanilla-parallelized] Verify volume expansion is not supported for PVC using vSAN-Default-Storage-Policy", func() {
	...
	ginkgo.It("[csi-block-vanilla] [csi-guest] [csi-supervisor] [csi-block-vanilla-parallelized] Verify volume expansion can happen multiple times", func() {
	...
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor]  [csi-block-vanilla-parallelized] Verify online volume expansion on dynamic volume", func() {
	...
	*/
	ginkgo.It("[csi-block-vanilla]  [csi-block-vanilla-parallelized] Verify online volume expansion on static volume", func() {
	...
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-guest]  [csi-block-vanilla-parallelized] Verify online volume expansion shrinking volume not allowed", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-guest]  [csi-block-vanilla-parallelized] Verify online volume expansion multiple times on the same PVC", func() {
	...
	*/
	...
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-guest] [csi-block-vanilla-serialized] Verify online volume expansion when VSAN-health is down", func() {
	...
	/*
		...
		11. Make sure file system has increased
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-guest] [csi-block-vanilla-serialized] Verify online volume expansion when SPS-Service is down", func() {
	...
	*/
	...
	ginkgo.It("[csi-block-vanilla] [csi-supervisor]  [csi-block-vanilla-parallelized] Verify online volume expansion by updating PVC with different sizes concurrently", func() {
	...
	/*
		...
		10.  Make sure file system has increased
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-block-vanilla-parallelized] Volume expansion on shared VVOL datastore", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
		var vmUUID string
		...
		if vanillaCluster {
			ginkgo.By("CNS_TEST: Running on Vanilla setup - This test covers Online volume expansion on PVC created on VVOL datastore")
		}
		if supervisorCluster {
			ginkgo.By("CNS_TEST: Running on SVC setup - This test covers Offline and Online expansion on PVC created on VVOL datastore")
		}
		...
		volHandle, pvclaim, pv, storageclass := createSCwithVolumeExpansionTrueAndDynamicPVC(f, client, sharedVVOLdatastoreURL, storagePolicyName, namespace)
		defer func() {
			err := client.StorageV1().StorageClasses().Delete(ctx, storageclass.Name, *metav1.NewDeleteOptions(0))
			gomega.Expect(err).NotTo(gomega.HaveOccurred())
			err = fpv.DeletePersistentVolumeClaim(client, pvclaim.Name, namespace)
	...
	/*
		...
		10.  Make sure file system has increased
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-block-vanilla-parallelized] Volume expansion on shared NFS datastore", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
		var vmUUID string
		...
		if vanillaCluster {
			ginkgo.By("CNS_TEST: Running on Vanilla setup - This test covers Online volume expansion on PVC created on NFS datastore")
		}
		if supervisorCluster {
			ginkgo.By("CNS_TEST: Running on SVC setup - This test covers Offline and Online expansion on PVC created on NFS datastore")
		}
		...
		volHandle, pvclaim, pv, storageclass := createSCwithVolumeExpansionTrueAndDynamicPVC(f, client, sharedNFSdatastoreURL, storagePolicyName, namespace)
		defer func() {
			err := client.StorageV1().StorageClasses().Delete(ctx, storageclass.Name, *metav1.NewDeleteOptions(0))
			gomega.Expect(err).NotTo(gomega.HaveOccurred())
			err = fpv.DeletePersistentVolumeClaim(client, pvclaim.Name, namespace)
	...
	/*
		...
		10.  Make sure file system has increased
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] [csi-block-vanilla-parallelized] Volume expansion on shared VMFS datastore", func() {
		ginkgo.By("Invoking Test for Volume Expansion")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
		var vmUUID string
		...
		volHandle, pvclaim, pv, storageclass := createSCwithVolumeExpansionTrueAndDynamicPVC(f, client, sharedVMFSdatastoreURL, storagePolicyName, namespace)
		defer func() {
			err := client.StorageV1().StorageClasses().Delete(ctx, storageclass.Name, *metav1.NewDeleteOptions(0))
			gomega.Expect(err).NotTo(gomega.HaveOccurred())
			err = fpv.DeletePersistentVolumeClaim(client, pvclaim.Name, namespace)
	...
	*/
	ginkgo.It("[csi-supervisor] Offline and Online volume resize on statically created volume", func() {
		...
		gomega.Expect(err).NotTo(gomega.HaveOccurred())
		framework.ExpectNoError(waitForCNSRegisterVolumeToGetCreated(ctx, restConfig, namespace, cnsRegisterVolume, poll, supervisorClusterOperationsTimeout))
	...
	*/
	ginkgo.It("[csi-supervisor] Verify offline volume expansion when PVC is deleted", func() {
		...
		storageclass, pvclaim, err = createPVCAndStorageClass(client, namespace, nil, scParameters, "", nil, "", true, "", thickProvPolicy)
		gomega.Expect(err).NotTo(gomega.HaveOccurred())
	...
	*/
	ginkgo.It("[csi-block-vanilla] [csi-supervisor] Verify online volume expansion on deployment", func() {
		...
		ginkgo.By("Create StorageClass with allowVolumeExpansion set to true, Create PVC")
		sharedVSANDatastoreURL := GetAndExpectStringEnvVar(envSharedDatastoreURL)
		_, pvclaim, pv, storageclass = createSCwithVolumeExpansionTrueAndDynamicPVC(f, client, sharedVSANDatastoreURL, storagePolicyName, namespace)
		...
		dep, err := createDeployment(ctx, client, 1, labelsMap, nil, namespace, []*v1.PersistentVolumeClaim{pvclaim}, "", false)
		gomega.Expect(err).NotTo(gomega.HaveOccurred())
...
func staticProvisioningPreSetUpUtil(ctx context.Context, f *framework.Framework, c clientset.Interface, storagePolicyName string) (*restclient.Config, *storagev1.StorageClass, string) {
	namespace := getNamespaceToRunTests(f)
...
func testCleanUpUtil(ctx context.Context, restClientConfig *restclient.Config, c clientset.Interface, cnsRegistervolume *cnsregistervolumev1alpha1.CnsRegisterVolume, namespace string, pvcName string, pvName string) {
	if guestCluster {
	...
	if cnsRegistervolume != nil {
		...
		framework.ExpectNoError(waitForCNSRegisterVolumeToGetDeleted(ctx, restClientConfig, namespace, cnsRegistervolume, poll, supervisorClusterOperationsTimeout))
	}
...
func offlineVolumeExpansionOnSupervisorPVC(client clientset.Interface, f *framework.Framework, namespace string, volHandle string, pvclaim *v1.PersistentVolumeClaim) (*v1.PersistentVolumeClaim, *v1.Pod, string) {
	ginkgo.By("Expanding current pvc")
	currentPvcSize := pvclaim.Spec.Resources.Requests[v1.ResourceStorage]
	newSize := currentPvcSize.DeepCopy()
	newSize.Add(resource.MustParse("1Gi"))
