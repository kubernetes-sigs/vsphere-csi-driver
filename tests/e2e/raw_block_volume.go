...
var _ = ginkgo.Describe("raw block volume support", func() {
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [cf-vks][csi-block-vanilla][csi-block-vanilla-parallelized][csi-guest]"+
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-block-vanilla] [csi-block-vanilla-parallelized] [csi-guest]"+
	...
	*/
	ginkgo.It("[cf-vks] [block-vanilla-snapshot] [cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [tkg-snapshot][ef-vks-snapshot] Verify snapshot "+
