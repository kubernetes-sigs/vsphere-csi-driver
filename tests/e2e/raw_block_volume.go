...
var _ = ginkgo.Describe("raw block volume support", func() {
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [cf-vks][csi-block-vanilla]"+
		"[csi-block-vanilla-parallelized][csi-guest]Statefulset testing with raw block volume and default "+
		"podManagementPolicy", ginkgo.Label(p0, block, vanilla, tkg, vc70), func() {
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block][cf-vks][csi-block-vanilla][csi-guest]"+
		"[csi-block-vanilla-parallelized]Should create and delete pod with the same "+
		"raw block volume", ginkgo.Label(p0, block, vanilla, tkg, vc70), func() {
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block][csi-block-vanilla]"+
		"[csi-block-vanilla-parallelized]Verify basic static "+
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [cf-vks][csi-block-vanilla]"+
		"[csi-block-vanilla-parallelized][csi-guest]Verify online volume expansion on dynamic raw "+
		"block volume", ginkgo.Label(p0, block, vanilla, tkg, vc70), func() {
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block][csi-block-vanilla]"+
		"[csi-block-vanilla-parallelized][csi-guest][ef-vks][ef-vks-n1][ef-vks-n2]"+
		"Verify offline volume expansion with raw block volume", ginkgo.Label(p0, block, vanilla, tkg, vc70), func() {
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	*/
	ginkgo.It("[cf-vks-f] [block-vanilla-snapshot] [cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]"+
		"[tkg-snapshot][ef-vks-snapshot] Verify snapshot dynamic provisioning workflow with raw "+
		"block volume", ginkgo.Label(p0, block, vanilla, tkg, vc70), func() {
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
