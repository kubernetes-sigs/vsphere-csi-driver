...
var _ = ginkgo.Describe("[csi-block-vanilla] [csi-block-vanilla-parallelized] Relocate detached volume ", func() {
	...
	*/
	ginkgo.It("[cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  Online relocation of volume using cnsRelocate Volume API", ginkgo.Label(p0,
	...
	5. Delete pvc and sc.
	*/
	ginkgo.It("[cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  Offline relocation of volume using cnsRelocate Volume API", ginkgo.Label(p0,
		vanilla, block, core, vc70), func() {
		ginkgo.By("Invoking Test for offline relocation")
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	*/
	...
	/*
		...
		Steps:
			...
			11. Delete all the objects created during the test.
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-block-vanilla][csi-block-vanilla-parallelized] Start volume relocation and "+
	...
	/*
		...
		Steps:
			...
			11. Delete all the objects created during the test.
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-block-vanilla][csi-block-vanilla-parallelized] Start volume relocation and take"+
