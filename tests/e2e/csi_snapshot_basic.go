...
var _ = ginkgo.Describe("Volume Snapshot Basic Test", func() {
	...
	*/
	...
	/*
	   VC password reset during snapshot creation ----------> Fail
	   1. Create a sc and pvc using this sc
	   ...
	   9. Cleanup pvc/sc
	*/
	ginkgo.It("[block-vanilla-snapshot][supervisor-snapshot] VC password reset during "+
		"snapshot creation", ginkgo.Label(p1, block, vanilla, snapshot, disruptive), func() {
