...
func TestE2E(t *testing.T) {
	...
	ginkgo.RunSpecs(t, "Restore-Snapshot-On-Different-Datastore-Tests", reporterConfig)
}
...
func handleFlags() {
	...
	framework.TestContext.RepoRoot = strings.ReplaceAll(mydir, "/tests/e2e/restore_snapshot", "")
	flag.Parse()
}
