...
func verifyStandalonePodAffinity(client clientset.Interface, pod *v1.Pod,
	...
	for _, sspod := range ssPods.Items {
		...
		for _, volumespec := range sspod.Spec.Volumes {
			if volumespec.PersistentVolumeClaim != nil {
				...
				isCorrectPlacement := multiVCe2eVSphere.verifyPreferredDatastoreMatchInMultiVC(pv.Spec.CSI.VolumeHandle, datastoreUrls)
