...
var _ = ginkgo.Describe("[vol-allocation] Policy driven volume space allocation tests", func() {
	...
	*/
	ginkgo.It("[ef-svc-volallowcation][csi-block-vanilla][csi-block-vanilla-parallelized][csi-guest][csi-supervisor]"+
		"[csi-wcp-vsan-direct][ef-vks-thickthin][cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  Verify Thin, EZT, LZT volume creation via SPBM "+
	...
	*/
	ginkgo.It("[ef-f-svc-volallowcation][csi-block-vanilla][csi-guest][csi-supervisor][csi-wcp-vsan-direct]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks-thickthin] Fill LZT/EZT volume", ginkgo.Label(p0, vanilla, block,
	...
	*/
	ginkgo.It("[ef-f-svc-volallowcation-neg][csi-block-vanilla][csi-guest][csi-supervisor][csi-wcp-vsan-direct]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks-thickthin] Verify large EZT volume creation which takes longer than "+
	...
	*/
	ginkgo.It("[ef-f-svc-volallowcation][csi-block-vanilla][csi-guest][csi-supervisor][csi-wcp-vsan-direct]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  Verify EZT online volume expansion to a large size which takes "+
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [ef-f-svc-volallowcation][cflater-wcp][csi-supervisor][csi-block-vanilla]"+
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [ef-f-svc-volallowcation][csi-guest][csi-supervisor][csi-block-vanilla]"+
	...
	*/
	ginkgo.It("[pq-f-svc-volallowcation-neg][csi-block-vanilla][csi-guest][csi-supervisor][pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] "+
	...
	*/
	...
	/*
		...
		Steps for online volumes:
			...
			12. Delete all the objects created during the test.
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-block-vanilla][csi-block-vanilla-parallelized] Start attached volume's "+
	...
	*/
	...
	/*
		...
		Steps for online volumes:
			...
			12. Delete all the objects created during the test.
	*/
	ginkgo.It("[csi-block-vanilla][csi-block-vanilla-parallelized][pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] "+
		" Start attached volume's conversion while creation of snapshot and"+
