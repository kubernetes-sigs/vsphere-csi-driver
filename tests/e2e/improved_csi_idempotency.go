...
var _ = ginkgo.Describe("Improved CSI Idempotency Tests", func() {
	...
	*/
	...
	ginkgo.It("[stable-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks][pq-vks-n1][pq-vks-n2] Reduce external provisioner timeout and create "+
	...
	*/
	ginkgo.It("[stable-f-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  create volume when hostd service goes down - "+
	...
	*/
	ginkgo.It("[stable-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks][pq-vks-n1][pq-vks-n2] create volume when CNS goes down - idempotency", ginkgo.Label(p0,
	...
	*/
	ginkgo.It("[stable-f-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  create volume when VPXD goes down - "+
		"idempotency", ginkgo.Label(p0, disruptive, block, file, windows, wcp, tkg, vanilla, vc70), func() {
	...
	*/
	ginkgo.It("[stable-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks][pq-vks-n1][pq-vks-n2] create volume when SPS goes down - idempotency", ginkgo.Label(p0,
	...
	*/
	ginkgo.It("[stable-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks][pq-vks-n1][pq-vks-n2] create volume when CSI restarts - idempotency", ginkgo.Label(p0,
		disruptive, block, file, windows, wcp, tkg, vanilla, vc70), func() {
		serviceName = "CSI"
		createVolumeWithServiceDown(serviceName, namespace, client, storagePolicyName,
			scParameters, volumeOpsScale, isServiceStopped, c)
	...
	*/
	ginkgo.It("[stable-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks][pq-vks-n1][pq-vks-n2] extend volume when csi restarts - idempotency", ginkgo.Label(p0,
		disruptive, block, file, windows, wcp, tkg, vanilla, vc70), func() {
		serviceName = "CSI"
	...
	*/
	ginkgo.It("[stable-pq-vks][csi-block-vanilla][csi-file-vanilla][csi-guest][csi-supervisor][pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]"+
		"[pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [pq-vks][pq-vks-n1][pq-vks-n2] extend volume when CNS goes down - idempotency", ginkgo.Label(p0,
		disruptive, block, file, windows, wcp, tkg, vanilla, vc70), func() {
		serviceName = vsanhealthServiceName
		extendVolumeWithServiceDown(serviceName, namespace, client, storagePolicyName, scParameters,
			volumeOpsScale, true, isServiceStopped, c)
