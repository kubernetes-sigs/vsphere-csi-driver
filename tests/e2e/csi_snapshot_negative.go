...
var _ = ginkgo.Describe("[block-snapshot-negative] Volume Snapshot Fault-Injection Test", func() {
	...
	*/
	ginkgo.It("[block-vanilla-snapshot] [tkg-snapshot][supervisor-snapshot] TC24create volume snapshot when "+
	...
	ginkgo.It("[block-vanilla-snapshot] [tkg-snapshot][supervisor-snapshot] TC241create volume snapshot when CSI "+
	...
	ginkgo.It("[block-vanilla-snapshot] [tkg-snapshot][supervisor-snapshot] TC242create volume snapshot when VPXD "+
	...
	ginkgo.It("[block-vanilla-snapshot] [tkg-snapshot][supervisor-snapshot] TC243create volume snapshot when CNS goes "+
	...
	ginkgo.It("[block-vanilla-snapshot] [tkg-snapshot][supervisor-snapshot] TC244create volume snapshot when SPS "+
		"goes down", ginkgo.Label(p0, block, vanilla, tkg, snapshot, disruptive), func() {
	...
	ginkgo.It("[tkg-snapshot][supervisor-snapshot] TC245create volume snapshot when SVC CSI restarts", ginkgo.Label(p0,
