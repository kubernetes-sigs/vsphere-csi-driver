...
func waitAndVerifyCnsVolumeMetadata4GCVol(ctx context.Context, volHandle string, svcPVCName string, pvc *v1.PersistentVolumeClaim,
	pv *v1.PersistentVolume, pod *v1.Pod) error {

	waitErr := wait.PollUntilContextTimeout(ctx, healthStatusPollInterval, pollTimeoutSixMin, true, func(ctx context.Context) (bool, error) {
