...
var _ = ginkgo.Describe("Transaction_Support_CreateSnapshot", func() {
	...
	ginkgo.Context("When one or more services are down", func() {
		...
		ginkgo.DescribeTableSubtree("Transaction_Support_CreateSnapshot_Table_Tests",
...
func createVolumeSnapshotWithServiceDown(serviceNames []string, namespace string, client clientset.Interface,
	...
	diskSize := constants.DiskSize5GB //TODO modify these values as per datastore
	...
	framework.Logf("CreateSnapshot-------------------------%v", serviceNames)
