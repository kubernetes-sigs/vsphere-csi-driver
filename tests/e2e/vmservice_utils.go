...
// createVMServiceVmWithMultiplePvcs
...
// performVolumeLifecycleActionForVmServiceVM
func performVolumeLifecycleActionForVmServiceVM(ctx context.Context, client clientset.Interface,
	vmopC ctlrclient.Client, vmClass string, namespace string, vmi string,
	...
	gomega.Expect(waitNverifyPvcsAreAttachedToVmsvcVm(ctx, vmopC, vmopC, vm,
