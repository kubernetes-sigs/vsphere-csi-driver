...
func createVMServiceandWaitForVMtoGetIP(ctx context.Context, vmopC ctlrclient.Client, cnsopC ctlrclient.Client, namespace string,
	vms []*vmopv1.VirtualMachine, pvclaimsList []*v1.PersistentVolumeClaim, doCreateVmSvc bool, waitForVmIp bool) {
