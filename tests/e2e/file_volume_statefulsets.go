...
var _ = ginkgo.Describe("[csi-file-vanilla] File Volume statefulset", func() {
	...
	*/
	ginkgo.It("[cf-f-vanilla-file] Statefulset with file volume testing with default "+
	...
	/*
		...
		9. Delete the storage class.
	*/
	ginkgo.It("[cf-f-vanilla-file]Statefulset with file volume testing with parallel "+
		"podManagementPolicy", ginkgo.Label(p0, file, vanilla, core, vc70), func() {
		curtime := time.Now().Unix()
		randomValue := rand.Int()
		val := strconv.FormatInt(int64(randomValue), 10)
	...
	*/
	ginkgo.It("[pq-vanilla-file][pq-n1-vanilla-file][pq-n2-vanilla-file]Statefulset with file volume testing with"+
		" CSI daemonset restart", ginkgo.Label(p1, file, vanilla, core, negative, vc70), func() {
		curtime := time.Now().Unix()
		randomValue := rand.Int()
		val := strconv.FormatInt(int64(randomValue), 10)
		val = string(val[1:3])
