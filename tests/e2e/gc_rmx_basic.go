...
var _ = ginkgo.Describe("[csi-guest-rwx] File Volume Provision Test", func() {
	f := framework.NewDefaultFramework("rmx-tkg-basic")
	var (
	...
	*/
	...
	ginkgo.It("Verify RWX volume provision", func() {
	...
	*/
	...
	/*
		...
		7. Wait for Pod to be up and running
		8. Verify Read/Write operation on File volume
		9. Delete Pod and wait for pods to be deleted
