...
var _ = ginkgo.Describe("[vsan-stretch-vanilla] vsan stretched cluster tests", func() {
	...
	*/
	ginkgo.It("[primary-centric][control-plane-on-primary] Pod deletion while primary site goes down",
	...
	*/
	ginkgo.It("[primary-centric] PVC deletion while primary site goes down",
		ginkgo.Label(p0, vsanStretch, block, vanilla, wcp, tkg, primaryCentric), func() {
			ctx, cancel := context.WithCancel(context.Background())
			defer cancel()
			var svcCsipods *v1.PodList
	...
	*/
	...
	/*
	   ...
	   9.  Bring primary site up and wait for testbed to be back to normal
	*/
	ginkgo.It("[primary-centric] Label updates to PV, PVC, pod while primary site goes down",
		ginkgo.Label(p0, vsanStretch, block, vanilla, wcp, tkg, primaryCentric), func() {
	...
	*/
	ginkgo.It("[distributed] Operation Storm",
