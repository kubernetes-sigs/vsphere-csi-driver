...
func waitForPodsToBeInTerminatingPhase(ctx context.Context, sshClientConfig *ssh.ClientConfig, svcMasterIP string,
...
func waitForApiServerToBeUp(ctx context.Context, svcMasterIp string, sshClientConfig *ssh.ClientConfig,
