...
func verifyOnlineVolumeExpansionOnGc(ctx context.Context, client clientset.Interface, namespace string,
	svcPVCName string, volHandle string, pvclaim *v1.PersistentVolumeClaim,
	pod *v1.Pod, f *framework.Framework) {
	...
	onlineVolumeResizeCheck(f, ctx, client, namespace, svcPVCName, volHandle, pvclaim, pod)
...
func execStopContainerOnGc(ctx context.Context,
	client clientset.Interface, sshClientConfig *ssh.ClientConfig, svcMasterIP string, containerName string,
	gcMasterIP string, svcNamespace string, sshdPortNum string) error {
...
func waitForPodsToBeInTerminatingPhase(ctx context.Context,
...
func waitForApiServerToBeUp(ctx context.Context,
	client clientset.Interface, svcMasterIp string, sshClientConfig *ssh.ClientConfig,
