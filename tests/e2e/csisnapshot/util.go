...
*/
func CreateVolumeSnapshot(ctx context.Context, e2eTestConfig *config.E2eTestConfig, namespace string, pvclaim *v1.PersistentVolumeClaim, pv []*v1.PersistentVolume, diskSize string) (*snapV1.VolumeSnapshotClass, *snapV1.VolumeSnapshot, *snapV1.VolumeSnapshotContent) {
...
func CreateSnapshotInParallel(ctx context.Context, e2eTestConfig *config.E2eTestConfig, namespace string, volumeMap map[*v1.PersistentVolumeClaim][]*v1.PersistentVolume) (chan *snapV1.VolumeSnapshotClass, chan *snapV1.VolumeSnapshot, chan *snapV1.VolumeSnapshotContent) {
	...
	for pvclaim, pvList := range volumeMap {
		...
		go func() {
			defer wg.Done()
			snapshotClass, snapshot, snapContent := CreateVolumeSnapshot(ctx, e2eTestConfig, namespace, pvclaim, pvList, constants.DiskSize)
