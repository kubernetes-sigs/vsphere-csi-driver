...
require (
	...
	github.com/vmware-tanzu/vm-operator/external/byok v0.0.0-20260528162537-04308ad7298e
	...
	sigs.k8s.io/vsphere-csi-driver/v3 v3.7.1
)
...
require (
	...
	k8s.io/sample-controller v0.36.1 // indirect
