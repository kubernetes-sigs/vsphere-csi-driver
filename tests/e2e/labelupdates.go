...
var _ bool = ginkgo.Describe("[csi-block-vanilla] [csi-block-vanilla-parallelized] label-updates", func() {
	...
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-supervisor] verify labels are removed in CNS after removing them from pvc "+
	...
	ginkgo.It("[cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-supervisor] verify podname label is created/deleted when pod with cns volume is "+
	...
	*/
	...
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] Verify PVC name is removed from PV entry on CNS after PVC is deleted "+
	...
	*/
	...
	ginkgo.It("[cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  Verify label updates on statically provisioned volume.", ginkgo.Label(p0,
	...
	/*
		...
		11. Delete SC
	*/
	ginkgo.It("[cf-wcp][cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [csi-supervisor] Verify label updates on PVC and PV"+
