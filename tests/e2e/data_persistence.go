...
var _ = ginkgo.Describe("Data Persistence", func() {
	...
	ginkgo.It("[ef-wcp][csi-block-vanilla][cf-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]"+
		"[ef-vks][csi-supervisor][csi-guest][csi-block-vanilla-parallelized][ef-vks-n1][ef-vks-n2] Should create and"+
		" delete pod with the same volume source and data", ginkgo.Label(p0, block, vanilla, wcp, tkg, core,
		vc70), func() {
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
	...
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] "+
		"[csi-block-vanilla][csi-block-vanilla-parallelized] Dynamic volume provisioning data"+
