...
const (
	...
	envwcpNamespace                            = "WCP_NAMESAPACE_DELETE"
	...
	vcNamespaceAPI                             = "/api/vcenter/namespaces/instances"
	vcContentLibraryAPI                        = "/api/content/library"
	...
	wcpServiceName                             = "wcp"
	wcpNamespace                               = "test-gc-e2e-demo-ns"
