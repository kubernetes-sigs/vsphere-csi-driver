...
var _ = ginkgo.Describe("statefulset", func() {
	...
	*/
	...
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [ef-stretched-svc][cf-wcp][csi-block-vanilla][csi-supervisor]"+
	...
	/*
		...
		9. Delete the storage class.
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [ef-wcp][csi-block-vanilla][csi-supervisor][csi-block-vanilla-parallelized] Statefulset "+
	...
	*/
	ginkgo.It("[ef-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block] [ef-wcp][csi-block-vanilla][csi-supervisor][csi-block-vanilla-parallelized]"+
	...
	*/
	ginkgo.It("[ef-wcp][csi-block-vanilla][csi-supervisor][pq-vanilla-block][pq-n1-vanilla-block][pq-n2-vanilla-block]  ListVolumeResponse "+
