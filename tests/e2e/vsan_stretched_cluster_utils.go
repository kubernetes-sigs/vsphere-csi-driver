...
func waitForHostToBeDown(ctx context.Context, ip string) error {
	...
	waitErr := wait.PollUntilContextTimeout(ctx, poll*2, pollTimeoutShort*2, true, func(ctx context.Context) (bool, error) {
...
func waitForPodsToBeInErrorOrRunning(ctx context.Context, c clientset.Interface, podName, namespace string, timeout time.Duration) error {
