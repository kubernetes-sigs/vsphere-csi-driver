...
- [Dynamic Volume Provisioning](#dynamic_volume_provisioning)
  ...
  - [Dynamically provision a block volume in vSphere with Kubernetes Supervisor Cluster](#dynamic_volume_provisioning_pacific)
...
## Dynamic Volume Provisioning<a id="dynamic_volume_provisioning"></a>
  ...
  Dynamic Volume Provisioning is supported both in Vanilla Kubernetes clusters and vSphere with Kubernetes clusters.
...
### Dynamically provision a block volume in vSphere with Kubernetes Supervisor Cluster<a id="dynamic_volume_provisioning_pacific"></a>

In the case of `vSphere with Kubernetes` clusters, `StorageClass` creation happens automatically when a Storage Policy gets created.
...
### Comparison of Cluster Flavor and the corresponding Storage Class Parameters<a id="dynamic_volume_provisioning_comparison"></a>
   ...
   <table>
    ...
    <tr>
    <td>vSphere with Kubernetes Supervisor</td>
...
Static Volume Provisioning is supported only in Vanilla Kubernetes clusters but not in vSphere with Kubernetes clusters
