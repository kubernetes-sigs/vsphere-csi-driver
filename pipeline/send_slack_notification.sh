...
REASON="curl -X 'PUT' -H 'accept: application/json' -u ${TESTBED_POOL_SERVICE_BASIC_AUTH_USER}:<redacted> ${TESTBED_POOL_SERVICE_ENDPOINT}/v1/pool/${TESTBED_POOL_ID}/releaseTestbed/${TESTBED_ID}"
